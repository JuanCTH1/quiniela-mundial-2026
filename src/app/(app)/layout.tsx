...
export default async function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  const [profile, settings, liveMatchRes, nextMatchRes, alertRes] = await Promise.all([
    ...
    supabase.from('matches')
      .select('id, home_team, away_team, scheduled_time, early_unlock_at, stage, group_name, home_score_fulltime, away_score_fulltime, home_score_penalties, away_score_penalties, current_minute, current_period, actual_start_time, second_half_start_time, extra_time_start_time')
